...
extension SIMDStorage {
  ...
  public static var _hasVectorOperations: Bool {
    @_transparent 
    get {
      return _hasVectorRepresentation //TODO: `&& Builtin.isConcrete(Self.self)`
    }
  }
...
extension SIMDStorage {
  ...
  // public static func _divExact(_ lhs: Self, _ rhs: Self) -> Self {
  //   fatalError("In default SIMDStorageWithOps impl for \(Self.self)")
  // }
...
extension _SIMDVectorStorage {
  ...
  // @_transparent
  // public static func _div(_ lhs: Self, _ rhs: Self) -> Self {
  //   // Can do `fdiv`, `sdiv`, or `udiv`
  //   // return Self(_vector: Builtin.generic_div(lhs._vector, rhs._vector))
  // }

  // @_transparent
  // public static func _divExact(_ lhs: Self, _ rhs: Self) -> Self {
  //   return Self(_vector: Builtin.generic_div_exact()
  // }

  // @_transparent
  // public static func _rem(_ lhs: Self, _ rhs: Self) -> Self {
  //   // Can do `frem`, `srem`, or `urem`
  //   // return Self(_vector: Builtin.generic_rem(lhs._vector, rhs._vector))
  // }
  ...
  // public static func _shr(_ lhs: Self, _ rhs: Self) -> Self {
  //   // Can do `ashr` or `lshr`
  //   // return Self(_vector: Builtin.generic_shr(lhs._vector, rhs._vector))
  // }
...
// builtin functions.
//
// The `_fastPath` hint is used because these functions are almost always called
// on stdlib SIMD types which have `_hasVectorOperations` return `true`.
extension SIMD where Scalar: FixedWidthInteger {
  @_transparent
